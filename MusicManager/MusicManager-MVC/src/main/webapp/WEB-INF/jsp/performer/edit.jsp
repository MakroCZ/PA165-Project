            ...
            <div class="d-flex h-100 w-100" id="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <a class="navbar-brand" href="${pageContext.request.contextPath}/performer/list"><fmt:message key="performer.edit.title"/></a>
                    ...
                    <div  class="tab navbar navbar-expand-lg navbar-light mt-4">
                        <div class="d-flex w-100 p-4 align-items-center">
                            <!-- Container items -->
                            <form:form method="post" action="${pageContext.request.contextPath}/performer/save"
                                       modelAttribute="performerEdit" cssClass="form-horizontal">
                                <form:hidden path="id"/>
                                ...
                                <button class="btn btn-primary" type="submit"><fmt:message key="performer.edit.confirm"/></button>
                            </form:form>
                            <!-- End container items -->
                        </div>
